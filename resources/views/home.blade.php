...
<html lang="en">
  ...
  <head>
    ...
    <title>BrownBryan - Restaurant</title>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p> Welcome to our restaurant! We specialize in serving delicious, fresh food in a cozy atmosphere. Our restaurant has operated and has been in business for over some years. <br>We offer an enticing array of homemade dishes, crafted with the freshest ingredients. Our service is focused on delivering an enjoyable meal experience for all of our guests. <br>Our friendly staff is always willing to answer any questions you may have about our menu items. Come in and try us today! <br></p>
                        <div class="row">
                            <div class="col-4">
                ...
                <div class="owl-menu-item owl-carousel">
                    ...
                    <div class="item">
                        <div class='card card2'>
                            ...
                            <div class='info'>
                              <h1 class='title'>Brown Bryan Pancake</h1>
                              <p class='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedii do eiusmod teme.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                    ...
                    <div class="item">
                        <div class='card card3'>
                            ...
                            <div class='info'>
                              <h1 class='title'>Tall brownbryan Bread</h1>
                              <p class='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedii do eiusmod teme.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                                    ...
                                    <h4>Phone Numbers</h4>
                                    <span><a href="#">+254797209133</a><br><a href="#">+254797390269</a></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <h4>Emails</h4>
                                    <span><a href="#">brianmuthee818@gmail.com</a><br><a href="#">info@restaurant.com</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
                        <div class="copyright">
                            <p>Copyright © 2022-<script>document.write(new Date().getFullYear())</script> BrownBryan All Rights Reserved</p>
                       </div>
                    </div>
                </div>
            </div>
